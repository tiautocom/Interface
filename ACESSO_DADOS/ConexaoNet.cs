...
{
    public class ConexaoNet
    {
        private static string ConnectionString = ConfigurationManager.ConnectionStrings["StringConexaoWeb"].ToString();
        ...
        public object ExecutarManipulacao(CommandType commandType, string nomeStoreProcedureOuTextoSql, string dns)
        {
            try
            {
                ...
                sqlComando.CommandTimeout = 9200; // 7200  em segundos == (2horas), para prteger tempo de banco aberto por segurança........
